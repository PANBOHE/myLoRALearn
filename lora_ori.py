...
#核心代码
#主要是实现了LORA方法，并且融合了生成QKV的三个Linear的Class
...
class MergedLinear(nn.Linear, LoRALayer):
    ...
    def __init__(
        ...
        in_features: int,  #输入预训练的权重的大小，图当中的x，大小为embedding_size
        out_features: int, #输出是QKV的大小，但是这里是经过处理的
        ...
        ##是否合并LoRA矩阵与原始预训练模型的权重，在推理阶段最好是将两者合并
        ...
        **kwargs
        ...
        if r > 0 and any(enable_lora):
            ...
            self.scaling = self.lora_alpha / self.r #ΔW缩放因子
    ...
    def train(self, mode: bool = True):
        ...
        if self.merge_weights and should:
            if self.r > 0 and any(self.enable_lora):
                ...
                #self.zero_pad就是扩充到QKV三者都有的shape
